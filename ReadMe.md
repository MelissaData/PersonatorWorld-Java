...
This is a sample code for Melissa's Personator World API. It is written in JAVA and accesses the API through REST. 
...
* Run Windows Batch file (PersonatorWorldSample\src\Sample.bat) which will compile and run the Java Sample Code
